 ...
 * USB LED driver
 *
 * Copyright (C) 2004 Greg KroahHartman (greg@kroah.com)
 *
...
#define DRIVER_AUTHOR "Greg KroahHartman, greg@kroah.com"
...
/* the Webmail LED made by RISO KAGAKU CORP. decodes a color index
   ...
   from 1bit RGB to the riso kagaku color index according to this table... */
